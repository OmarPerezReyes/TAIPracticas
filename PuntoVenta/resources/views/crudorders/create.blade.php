            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Crear Orden</h4>
                    </div>
                </div>
                    ...
                    @csrf
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" step="0.01" class="form-control @error('paid') is-invalid @enderror" id="paid" name="paid" value="{{ old('paid') }}" required>
                                @error('paid')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" step="0.01" class="form-control @error('change') is-invalid @enderror" id="change" name="change" value="{{ old('change') }}" required>
                                @error('change')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
