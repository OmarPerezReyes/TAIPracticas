                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="mb-2">{{ $customer->razon_social }}</p>
                    ...
                    <ul class="list-inline p-0 m-0">
                        ...
                        <li class="mb-2">
                            <div class="d-flex align-items-center">
                                ...
                                <p class="mb-0">{{ $customer->codigo_postal }}</p>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="list-inline p-0 mb-0">
                        ...
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $customer->RFC }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $customer->razon_social }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $customer->codigo_postal }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $customer->regimen_fiscal }}" readonly>
                                </div>
                            </div>
                        </li>
                    </ul>
